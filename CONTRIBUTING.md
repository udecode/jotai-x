...
Thanks for your interest in improving `jotai-x`! We are a
...
- Search the
  [issue list](https://github.com/udecode/jotai-x/issues?utf8=%E2%9C%93&q=)
...
1. `cd ~` (optional)
2. `git clone https://github.com/udecode/jotai-x.git` _bonus_: use your own fork for this step
3. `cd jotai-x`
4. `corepack enable`
5. `yarn install`
6. `yarn build`
...
[PR template](https://github.com/udecode/jotai-x/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
[Q&A](https://github.com/udecode/jotai-x/discussions/categories/q-a) is a
